...
module.exports = class ExtendedClient extends Client {
  constructor() {
    ...
    this.pagi = require('../plugins/pagi');
    this.emb = require('../plugins/emb');  
    this.dab = new Database("mongodb+srv://raand:raand@cluster0.gm1i8y9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0");
    this.dab.connect()
      mongoose.connect("mongodb+srv://raand:raand@cluster0.gm1i8y9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0", {
  ...
  connect = async (token, prefix = "n", emoji, color, auth, voteUri) => {
    this.prefix = prefix;
