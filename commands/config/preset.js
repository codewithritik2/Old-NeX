          ...
          new client.embed()
            .desc(
              `${emoji.cog} **Current play-embed preset :**\n` +
                `*You can choose a new one using the buttons provided below dont forget to click [**Select**](https://discord.gg/belove) to save!*`,
            )
      ...
      if (collected.size == 0 || !selected.includes("confirm")) {
        ...
        await m
          .edit({
            embeds: [
              new client.embed()
                .desc(`<:emoji_54:1163657555906666596> **Current play-embed preset :**`)
                .img(`attachment://${attachment.name}`)
