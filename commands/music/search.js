...
module.exports = {
  ...
  execute: async (client, message, args, emoji) => {
    ...
    const loading = {
      embeds: [
        new client.embed().desc(
          `<a:search:1305857113553240114> **Searching please wait. . . **`,
        ),
      ],
    };
    ...
    let resObj = {
      embeds: [
        new client.embed()
          ...
          .setFooter({
            text: `Let's get musical! Brought to you by Tanmay`,
          }),
      ],
      components: [row],
    };
