      ...
      .reply({
        embeds: [
          new client.embed().desc(
            `${emoji.cool} **Tuning parameters for an ultra-rich, full-bodied sound!**`,
          ),
        ],
        components: [],
      })
            ...
            .edit({
              embeds: [
                new client.embed().desc(
                  `${
                    `${res}\n` +
                    `${emoji.yes} Set volume to **80%** to minimize distortions\n` +
                    `${emoji.yes} Optimized params for the best listening experience.\n` +
                    `${emoji.yes} Audio spectrum calibrated **Harman target 2019**\n`
                  }`,
                ),
              ],
              components: [],
